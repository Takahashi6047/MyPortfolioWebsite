...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-[85vh] px-4 sm:px-6 md:px-8">
      ...
      <div 
        className={`relative w-full rounded-2xl sm:rounded-3xl bg-neutral-300 dark:bg-neutral-800 overflow-hidden bg-cover bg-center bg-no-repeat transition-all duration-700 ease-out transform-gpu ${
          isContainerVisible 
      ...
      >
        ...
        {/* Corner brackets */}
        {/* Top left corner */}
        <div className={`absolute top-4 left-4 sm:top-6 sm:left-6 transition-all duration-500 ease-out ${
          visibleElements.corners ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 -translate-x-2 -translate-y-2'
        }`}>
          <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 border-l-2 border-t-2 border-white/60 rounded-tl-md"></div>
        </div>
        
        {/* Top right corner */}
        <div className={`absolute top-4 right-4 sm:top-6 sm:right-6 transition-all duration-500 ease-out ${
          visibleElements.corners ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 translate-x-2 -translate-y-2'
        }`}>
        ...
        {/* Bottom left corner */}
        <div className={`absolute bottom-4 left-4 sm:bottom-6 sm:left-6 transition-all duration-500 ease-out ${
          visibleElements.corners ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 -translate-x-2 translate-y-2'
        }`}>
        ...
        {/* Bottom right corner */}
        <div className={`absolute bottom-4 right-4 sm:bottom-6 sm:right-6 transition-all duration-500 ease-out ${
          visibleElements.corners ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 translate-x-2 translate-y-2'
        }`}>
        ...
        <div className="absolute inset-0 p-4 sm:p-6 md:p-8 flex flex-col justify-between">
          ...
          <div className="pt-4 sm:pt-6 md:pt-8 ml-2 sm:ml-4 md:ml-5">
            <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-white tracking-tight transition-all duration-600 ease-out ${
              visibleElements.title ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
            }`}>
              ARTCODED
            </h1>
            <p className={`text-xs sm:text-sm md:text-base font-light text-white/80 mt-1 sm:mt-2 ml-0 sm:ml-20 md:ml-32 lg:ml-40 transition-all duration-600 ease-out delay-100 ${
              visibleElements.subtitle ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}>
          ...
          <div className={`absolute top-1/2 left-0 right-0 -translate-y-1/2 flex justify-evenly px-8 sm:px-12 md:px-16 pointer-events-none transition-all duration-500 ease-out ${
            visibleElements.decorative ? 'opacity-100 scale-100' : 'opacity-0 scale-75'
          }`}>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-3 sm:gap-0">
            ...
            <div className={`max-w-[300px] sm:max-w-xs md:max-w-sm ml-2 sm:ml-4 md:ml-5 mb-0 sm:mb-4 md:mb-5 order-2 sm:order-1 transition-all duration-600 ease-out ${
              visibleElements.quote ? 'opacity-100 translate-y-0 translate-x-0' : 'opacity-0 translate-y-4 -translate-x-4'
            }`}>
            ...
            <div className={`order-1 sm:order-2 sm:contents transition-all duration-600 ease-out ${
              visibleElements.card ? 'opacity-100 translate-y-0 translate-x-0' : 'opacity-0 translate-y-4 translate-x-4'
            }`}>
              <HeroCard />
            </div>
          </div>
